...
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_CHARACTER;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_COLLATE;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_DEFAULT;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_DESC;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_DESCRIBE;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_FOR;
...
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_LIMIT;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_OPTION;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_READ;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_SET;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_SHOW;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.KW_WHERE;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.OP_ASSIGN;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.OP_ASTERISK;
import static com.elong.pb.newdda.parser.recognizer.mysql.MySQLToken.OP_EQUALS;
...
import com.elong.pb.newdda.parser.ast.expression.primary.SysVarPrimary;
import com.elong.pb.newdda.parser.ast.expression.primary.UsrDefVarPrimary;
import com.elong.pb.newdda.parser.ast.expression.primary.VariableExpression;
import com.elong.pb.newdda.parser.ast.expression.primary.literal.LiteralString;
import com.elong.pb.newdda.parser.ast.fragment.Limit;
import com.elong.pb.newdda.parser.ast.fragment.VariableScope;
import com.elong.pb.newdda.parser.ast.stmt.SQLStatement;
import com.elong.pb.newdda.parser.ast.stmt.dal.DALSetCharacterSetStatement;
import com.elong.pb.newdda.parser.ast.stmt.dal.DALSetNamesStatement;
import com.elong.pb.newdda.parser.ast.stmt.dal.DALSetStatement;
import com.elong.pb.newdda.parser.ast.stmt.dal.DALShowStatement;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowAuthors;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowBinLogEvent;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowBinaryLog;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowCharaterSet;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowCollation;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowColumns;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowContributors;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowCreate;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowDatabases;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowEngine;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowEngines;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowErrors;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowEvents;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowFunctionCode;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowFunctionStatus;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowGrants;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowIndex;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowMasterStatus;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowOpenTables;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowPlugins;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowPrivileges;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowProcedureCode;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowProcedureStatus;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowProcesslist;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowProfile;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowProfiles;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowSlaveHosts;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowSlaveStatus;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowStatus;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowTableStatus;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowTables;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowTriggers;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowVariables;
import com.elong.pb.newdda.parser.ast.stmt.dal.ShowWarnings;
import com.elong.pb.newdda.parser.ast.stmt.ddl.DescTableStatement;
import com.elong.pb.newdda.parser.ast.stmt.mts.MTSSetTransactionStatement;
